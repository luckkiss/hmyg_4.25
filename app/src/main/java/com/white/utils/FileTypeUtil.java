...
public class FileTypeUtil {
    ...
    /**
     * 设置获取 视频 的字段 名称 ID 目录 目录名 图片路径
     */
    public static final String[] STORE_VIDEOS = {
            MediaStore.Video.VideoColumns.DISPLAY_NAME, // 显示的名称
            MediaStore.Video.VideoColumns.DISPLAY_NAME, // 显示的名称
            MediaStore.Video.VideoColumns._ID, // ID
            MediaStore.Video.VideoColumns.BUCKET_ID, // dir id 目录ID
            MediaStore.Video.VideoColumns.BUCKET_DISPLAY_NAME, // dir name 目录名字
            MediaStore.Video.VideoColumns.DATA, // 目录的路径
            MediaStore.Video.VideoColumns.SIZE, // 文件的大小
