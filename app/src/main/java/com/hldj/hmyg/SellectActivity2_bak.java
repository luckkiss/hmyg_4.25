...
public class SellectActivity2_bak extends BaseSecondActivity implements
...
//        mFlowLayout1 = (TagFlowLayout) findViewById(R.id.id_flowlayout1);
                            ...
                            if ("1".equals(code)) {
                                ...
                                if (specRankList.length() > 0) {
                                    ...
                                    if (guige_names.size() > 0) {
                                        ...
                                        adapter1 = new TagAdapter<String>(
                                                guige_names) {
                                ...
                                if (specList.length() > 0) {
                                    ...
                                    if (danwei_names.size() > 0) {
                                        ...
                                        adapter2 = new TagAdapter<String>(
                                                danwei_names) {
                                ...
                                if (plantTypeList.length() > 0) {
                                    ...
                                    for (int i = 0; i < plantTypeList.length(); i++) {
                                        ...
                                        planttype_names.add(JsonGetInfo.getJsonString(plantTypeList.getJSONObject(i), "text"));
                                        planttype_ids.add(JsonGetInfo.getJsonString(plantTypeList.getJSONObject(i), "value"));

                                    }

                                    if (planttype_names.size() > 0) {

                                        adapter3 = new TagAdapter<String>(planttype_names) {

                                            @Override
                                            public View getView(FlowLayout parent, int position, String s) {
                                                TextView tv = (TextView) getLayoutInflater().inflate(R.layout.tv, mFlowLayout3, false);
                                                tv.setText(s);
                                                return tv;
                                            }
                                        };
                                        ...
                                        mFlowLayout3.setOnTagClickListener((view, position, parent) -> {
                                            if (planttype_has_ids.toString().contains(planttype_ids.get(position))) {
                                                planttype_has_ids.remove(planttype_ids.get(position));
                                            } else {
                                                planttype_has_ids.add(planttype_ids.get(position));
                                            }
                                            return true;
                                        });
                                        ...
                                        for (int i = 0; i < planttype_has_ids.size(); i++) {
                                            for (int j = 0; j < planttype_ids.size(); j++) {
                                                if (planttype_ids.get(j).equals(planttype_has_ids.get(i))) {
            ...
            if (flag) {
                switch (view.getId()) {
                    ...
                    case R.id.sure:
                        ...
                        String str = GetCodeByName.initProvinceDatas(SellectActivity2_bak.this, mCurrentProviceName, mCurrentCityName);
                        ...
                        intent.putExtra("minPrice", et_minPrice.getText().toString());
                        intent.putExtra("maxPrice", et_maxPrice.getText().toString());
                        intent.putExtra("minDiameter", et_minDiameter.getText().toString());
                        intent.putExtra("maxDiameter", et_maxDiameter.getText().toString());
                        ...
                        intent.putExtra("minLength", et_minLength.getText().toString());
                        intent.putExtra("maxLength", et_maxLength.getText().toString());
                        intent.putExtra("minCrown", et_minCrown.getText().toString());
                        intent.putExtra("maxCrown", et_maxCrown.getText().toString());
                        intent.putExtra("minOffbarHeight", et_minOffbarHeight.getText().toString());
                        intent.putExtra("maxOffbarHeight", et_maxOffbarHeight.getText().toString());
    ...
    private void showCitys() {
        ...
        tv_sure.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!SellectActivity2_bak.this.isFinishing() && dialog != null) {
                    if (dialog.isShowing()) {
                        dialog.cancel();
                    } else {
                        dialog.show();
        ...
        if (!SellectActivity2_bak.this.isFinishing() && dialog.isShowing()) {
            dialog.cancel();
        } else if (!SellectActivity2_bak.this.isFinishing() && dialog != null
                && !dialog.isShowing()) {
            dialog.show();
        }
    ...
    private void setUpData() {
        initProvinceDatas();
        mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(SellectActivity2_bak.this, mProvinceDatas));
