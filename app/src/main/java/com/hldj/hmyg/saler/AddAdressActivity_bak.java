...
public class AddAdressActivity_bak extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_adress_bak);
        ...
        if (getExtral() != null) {
            ...
            type = "";
            D.e("==type没有修改==");
            mainType = getExtral().mainType;
            isDefault2 = getExtral().isDefault;
            remmber.setChecked(isDefault2);
            tv_area.setText(GetCitiyNameByCode.initProvinceDatas(
                    AddAdressActivity_bak.this, cityCode));
            tv_street.setText(cityName.replace(GetCitiyNameByCode
                    .initProvinceDatas(AddAdressActivity_bak.this, cityCode), ""));
            ...
            if (flag) {
                switch (view.getId()) {
                    case R.id.btn_back:
                        ...
                        break;
                    case R.id.ll_01:
                        new ActionSheetDialog(AddAdressActivity_bak.this)
                                .builder()
                                .setTitle("苗圃类型")
                                .setCancelable(false)
                    ...
                    case R.id.ll_03:
                        ...
                        break;
                    case R.id.ll_04:
                        Intent intent = new Intent(AddAdressActivity_bak.this,
                                EventsActivity.class);
                        startActivityForResult(intent, 1);
                        break;
                    case R.id.edit_btn:
                        DelAdress(AddAdressActivity_bak.this, id);
                        break;
                    case R.id.save:
                        // if ("".equals(type)) {
                        ...
                        // }
                        if ("".equals(mCurrentZipCode)) {
                            Toast.makeText(AddAdressActivity_bak.this, "请选择地区",
                                    Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (SaveMiaoActivity.instance == null) {
                            if ("".equals(twCitycityCode)) {
                                Toast.makeText(AddAdressActivity_bak.this, "请选择街道",
                                        Toast.LENGTH_SHORT).show();
                                return;
                            }
                        }
            ...
            finalHttp.post(GetServerUrl.getUrl() + "city/getChilds", params,
                    new AjaxCallBack<Object>() {
                        ...
                        public void onFailure(Throwable t, int errorNo,
                                              String strMsg) {
                            // TODO Auto-generated method stub
                            Toast.makeText(AddAdressActivity_bak.this,
    ...
    private void showCitys() {
        if (dialog == null) {
            ...
            tv_sure.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!AddAdressActivity_bak.this.isFinishing() && dialog != null) {
                        if (dialog.isShowing()) {
                            dialog.cancel();
                        } else {
                            dialog.show();
        ...
        if (!AddAdressActivity_bak.this.isFinishing() && dialog.isShowing()) {
            dialog.cancel();
        } else if (!AddAdressActivity_bak.this.isFinishing() && dialog != null
                && !dialog.isShowing()) {
            dialog.show();
        }
    }
    ...
    private void showAreas() {
        View dia_choose_share = getLayoutInflater().inflate(  R.layout.dia_choose_area, null);
        TextView tv_sure = (TextView) dia_choose_share
                .findViewById(R.id.tv_sure);
        ...
        id_Childs.setViewAdapter(new ArrayWheelAdapter<String>(
                AddAdressActivity_bak.this, mStreetDatas));
        // 设置可见条目数量
        ...
        tv_sure.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!AddAdressActivity_bak.this.isFinishing() && dialog1 != null) {
        ...
        if (!AddAdressActivity_bak.this.isFinishing() && dialog1.isShowing()) {
            dialog1.cancel();
        } else if (!AddAdressActivity_bak.this.isFinishing() && dialog1 != null
                && !dialog1.isShowing()) {
            dialog1.show();
        }
    ...
    private void setUpData() {
        ...
        mViewProvince.setViewAdapter(new ArrayWheelAdapter<String>(
                AddAdressActivity_bak.this, mProvinceDatas));
        // 设置可见条目数量
    ...
    private void showSelectedResult() {
        Toast.makeText(
                AddAdressActivity_bak.this,
                "当前选中:" + mCurrentProviceName + "," + mCurrentCityName + ","
                        + mCurrentDistrictName + "," + mCurrentZipCode,
                Toast.LENGTH_SHORT).show();
    }

    public static void DelAdress(Activity activity, String id) {
        // TODO Auto-generated method stub
        FinalHttp finalHttp = new FinalHttp();
                ...
                new AjaxCallBack<Object>() {
                    ...
                    public void onSuccess(Object t) {
                        ...
                        try {
                            ...
                            if ("1".equals(code)) {
                                activity.setResult(ConstantState.CHANGE_DATES);
                                activity.finish();
                            } else {
                    ...
                    public void onFailure(Throwable t, int errorNo,
                                          String strMsg) {
                        // TODO Auto-generated method stub
//                        Toast.makeText(AddAdressActivity_bak.this, R.string.error_net, Toast.LENGTH_SHORT).show();
                        super.onFailure(t, errorNo, strMsg);
                    }
                    ...
                    public void onSuccess(Object t) {
                        ...
                        try {
                            ...
                            String msg = JsonGetInfo.getJsonString(jsonObject,
                                    "msg");
                            if (!"".equals(msg)) {
                                Toast.makeText(AddAdressActivity_bak.this, msg,
                                        Toast.LENGTH_SHORT).show();
                            }
                            if ("1".equals(code)) {
    ...
    public void onGeocodeSearched(GeocodeResult result, int rCode) {
        ...
        if (rCode == 1000) {
            if (result != null && result.getGeocodeAddressList() != null
                ...
                Toast.makeText(AddAdressActivity_bak.this, R.string.no_result, Toast.LENGTH_SHORT)
                        .show();
            }

        } else {
            Toast.makeText(AddAdressActivity_bak.this, rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (amapLocation != null && amapLocation.getErrorCode() == 0) {
                ...
                if (getIntent().getStringExtra("id") == null) {
                    ...
                    if (!"".equals(GetCitiyNameByCode.initProvinceDatas(
                            AddAdressActivity_bak.this, adCode))
...
//			 getIntent().getSerializableExtra("address");
            return null;
//            new NullPointerException("地址没有传过来");
        }
        return ((AddressBean) getIntent().getSerializableExtra("address"));

    }

    public static void start2Activity(Activity activity, AddressBean addressBean) {
        Intent intent = new Intent(activity, AddAdressActivity_bak.class);
        if (addressBean != null) {
