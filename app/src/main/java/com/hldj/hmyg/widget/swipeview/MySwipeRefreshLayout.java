    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (this.getChildCount() > 1) {
            ...
            if (!this.isInEditMode() || attrs != null) {
                ...
                int resId = ta.getResourceId(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                if (resId == -1) {
                    this.mGuidanceViewBgColor = ta.getColor(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                } else {
                ...
                if (resId == -1) {
                    this.mGuidanceViewTextColor = ta.getColor(R.styleable.SHSwipeRefreshLayout_load_text, -16777216);
                } else {
                ...
                if (resId == -1) {
                    this.mProgressBgColor = ta.getColor(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                } else {
                ...
                resId = ta.getResourceId(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                if (resId == -1) {
                    this.mProgressColor = ta.getColor(R.styleable.SHSwipeRefreshLayout_load_text, -65536);
                } else {
                ...
                resId = ta.getResourceId(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                if (resId == -1) {
                    this.mRefreshDefaulText = ta.getString(R.styleable.SHSwipeRefreshLayout_load_text);
                } else {
                ...
                resId = ta.getResourceId(R.styleable.SHSwipeRefreshLayout_load_text, -1);
                if (resId == -1) {
                    this.mLoadDefaulText = ta.getString(R.styleable.SHSwipeRefreshLayout_load_text);
                } else {
