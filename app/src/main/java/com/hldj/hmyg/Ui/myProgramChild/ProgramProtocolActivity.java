...
public class ProgramProtocolActivity extends ProgramDirctActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener {
...
//        add(new ProgramFragment1());
    ...
    public void initView() {
        ...
        RadioButton rbLeft = getView(R.id.rb_title_left);
        RadioButton rbRight = getView(R.id.rb_title_right);
        rbLeft.setText(list_title.get(0));
        rbRight.setText(list_title.get(1));
    ...
    public static void start(Activity mActivity, String project_id) {
        Intent intent = new Intent(mActivity, ProgramProtocolActivity.class);
