...
public class StorePurchaseListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_10 = inflate.findViewById(R.id.tv_10);
        TextView tv_11 = inflate.findViewById(R.id.tv_11);
        TextView tv_caozuo01 = inflate.findViewById(R.id.tv_caozuo01);
        TextView tv_caozuo02 = inflate
                .findViewById(R.id.tv_caozuo02);
        TextView tv_caozuo03 = inflate.findViewById(R.id.tv_caozuo03);//立马报价按钮
