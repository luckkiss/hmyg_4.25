...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog initItemsAndAddListener(final onItemClickListener onItemClickListener) {
        ...
        if (itemBeen.size() == 0) {
            ...
            itemBeen.add(new itemBean("crowd", "丛"));
            itemBeen.add(new itemBean("jin", "斤"));
            itemBeen.add(new itemBean("squaremeter", "平方米"));
            itemBeen.add(new itemBean("dai", "袋"));
            itemBeen.add(new itemBean("pen", "盆"));
        }
        ...
        for (int i = 0; i < itemBeen.size(); i++) {
            ...
            sheetItemList.add(new SheetItem(itemBeen.get(i).value, SheetItemColor.Blue, new OnSheetItemClickListener() {
                @Override
                public void onClick(int which) {
                    onItemClickListener.onItemClick(itemBeen.get(which));
                }
            }));
        }
...
//        setSheetItems();
    ...
    public static class itemBean {
        ...
        itemBean(String key, String value) {
            this.key = key;
            this.value = value;
        }
