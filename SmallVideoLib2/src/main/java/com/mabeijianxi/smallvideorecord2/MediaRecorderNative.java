...
//1280 ,720
        FFmpegBridge.prepareJXFFmpegEncoder(mMediaObject.getOutputDirectory(), mMediaObject.getBaseName(), vCustomFormat, SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT, SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT, mFrameRate, mVideoBitrate);

        Log.i("out w  h", "startRecord: " + SMALL_VIDEO_WIDTH + "  " + SMALL_VIDEO_HEIGHT);
