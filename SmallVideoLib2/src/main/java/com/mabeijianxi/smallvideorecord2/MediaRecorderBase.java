...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
     ...
     * 小视频宽度
     */
    public static int SMALL_VIDEO_WIDTH = 960;
    ...
    public static int mSupportedPreviewHeight = 0;
    /**
     * 状态标记
     */
...
//            Size size = getOptimalPreviewSize(mSupportedPreviewSizes, SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT);
...
////            SMALL_VIDEO_HEIGHT = size.height;
            ...
            double fl = (double) mSupportedPreviewSizes.get(i).width / mSupportedPreviewSizes.get(i).height;
            Log.i(TAG, "Width=: " + mSupportedPreviewSizes.get(i).width + "  ----   HEIGHT= " + mSupportedPreviewSizes.get(i).height + "    " + fl);
//
...
//            break;
        ...
        Size bestSize = getOptimalPreviewSize(mSupportedPreviewSizes, SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT);
        ...
        Log.w(TAG, "best size : " + bestSize.width + "  bestSize height= " + bestSize.height);
//        }


//        if (!findWidth) {
//        Log.e(getClass().getSimpleName(), "传入高度不支持或未找到对应宽度,请按照要求重新设置，否则会出现一些严重问题");
//            mSupportedPreviewWidth = mSupportedPreviewSizes.get(0).width;

//        checkFullWidth(960, 960);
//        SMALL_VIDEO_HEIGHT = 720;
//        SMALL_VIDEO_WIDTH = 960;
//        SMALL_VIDEO_HEIGHT = 960;
//        SMALL_VIDEO_WIDTH = 540;
//        Size size = getOptimalPreviewSize(mSupportedPreviewSizes, SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT);//根据小视频的宽高 得到预览的尺寸

//        Log.i(TAG, "mSurfaceWidth:=  " + mSurfaceWidth + "  mSurfaceHeight1" + mSurfaceHeight);


        //
//        SMALL_VIDEO_HEIGHT = size.height;
//        SMALL_VIDEO_WIDTH = size.width;
//        mSupportedPreviewWidth = size.width;// 1920
//        mSupportedPreviewWidth = // 1920
//        mSupportedPreviewHeight = size.height; // 1920
//        mSupportedPreviewWidth = SMALL_VIDEO_WIDTH;

//            mSupportedPreviewWidth = 1280;
//            checkFullWidth(1280, 720);
//            checkFullWidth(1080, 1920);
//            SMALL_VIDEO_HEIGHT = 720;
//            SMALL_VIDEO_HEIGHT = mSupportedPreviewSizes.get(0).height;
//        }
//        mParameters.setPreviewSize(1080, 1920);
        mParameters.setPreviewSize(SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT);// 宽高预览
//        mParameters.setPreviewSize(1280, 720);// 宽高预览
